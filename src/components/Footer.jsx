...
const Footer = ({theme}) => {
  return (
    ...
    sm:px-10 lg:px-24 xl:px-40 '>
        {/* footer top */}
      <div className='flex judtify-between lg:items-center max-lg:flex-col gap-10'>
        <div className='space-y-5 text-sm text-gray-700
        dark:text-gray-400'>
            <img src={theme === 'dark' ? assets.logo1 : assets.logo1} className='w-32 sm:w-44' alt=""/>
            <p className='max-w-md'>From strategy to execution, we craft digital
             ...
             <ul className='flex gap-8'>
                ...
                <li><a className='hover:text-primary' href="#client">Client</a></li>
                <li><a className='hover:text-primary' href="#contact-us">Contact Us</a></li>
             </ul>
        </div>
        <div className='text-gray-600 dark:text-gray-400'>
            <h3 className='font-semibold'>Subscribe to our newsletter</h3>
              <p className='text-sm mt-2 mb-6'>Subscribe to our newsletter and receive the latest news about 
      ...
      justify-center sm:justify-between gap-4 flex-wrap'>
        <p>© 2025 All Right Reserved
          Development by echspire Solutions(PVT)LTD. Kandy, Sri Lanka.</p>
