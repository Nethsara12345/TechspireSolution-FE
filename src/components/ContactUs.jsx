...
const ContactUs = () => {
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        <Title title='Rreach Out to Us' desc='From strategy to execution, we craft
         digital solutionns that move your business forward.' />

         <form className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2x1 w-full'>
          ...
          <div>
           ...
           <div className='sm:col-span-2'>
              <p className='mb-2 text-sm font-medium'>Messeage</p>
